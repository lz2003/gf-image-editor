...
/**
 * Note: All credit goes to mBread for this class. I had to get rid of
 * the extra java.awt code as it is no longer compatible with greenfoot
 * fonts and colors
 * Link: https://www.greenfoot.org/scenarios/575
 * 
...
public class Slider extends Actor
{
    ...
    private boolean showValue = false, showPercentage = false, imagesInvalid = true;
    ...
    /**
     * Get the current value as a float. Converts the range from 0-100
     * to between 0-1. Added by Lucy Zhao.
     * 
     * @return The current selected value as a float
     */
